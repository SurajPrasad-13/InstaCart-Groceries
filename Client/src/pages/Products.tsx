        ...
        <div className="flex gap-8 xl:gap-10">
          ...
          <main className=" flex-1">
            ...
            {loading ? (
              ...
              <div className=" grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 xl:grid-cols-8">
                {products.map(
                  (product) =>
                    product.stock > 0 && (
              ...
              <div className="flex-center gap-2 mt-16">
                {Array.from({ length: totalPages }).map((_, i) => (
                  <button
                    ...
                    className={` size-9 rounded-lg tesm *:font-medium transition-colors ${page === i + 1 ? "bg-app-green text-white" : " bg-white text-app-text-light hover:bg-app-cream"}`}
                  >
                    {i + 1}
                  </button>
                ))}
