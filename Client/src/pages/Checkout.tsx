...
import { ArrowLeft, ChevronRightIcon, MapPinIcon } from "lucide-react";
...
const Checkout = () => {
  ...
  const steps: { key: string; label: string; icon: typeof MapPinIcon }[] = [
    ...
    { key: "payment", label: "Payment", icon: MapPinIcon },
    { key: "review", label: "Review", icon: MapPinIcon },
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className=" grid md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2">
              {step === "address" && (
                <CheckoutAddress address={address} setAddress={setAddress} setStep = {setstep}  />
              )}
              {step === "payment" && (
            ...
            <div className="bg-white rounded-2xl p-5 h-fit sticky top-24">
              ...
              <div className=" space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{deliveryFee === 0 ? <span className=" to-app-success">Free </span> :`${currency}${deliveryFee.toFixed(2)}`} </span>
                </div>
