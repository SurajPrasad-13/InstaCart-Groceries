    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
        ...
        <div className=" relative text-center px-12">
          ...
          <p className="text-white/60 font-serif text-left maxwsm ms-auto">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <Link to="/" className=" inline-flex items-center gap-2 mb-6">
              <BikeIcon className=" text-2xl font-semibold" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button type="submit" disabled={loading} className=" flex-center w-full py-3 bg-green-950 text-white font-semibold rounded-xl hover:bg-green-900 transition-colors disabled:opacity-50"> {loading? <Loader2Icon className=" animate-spin"/> : isLoginState ?'Sign In':'Sign Up' } </button>
          </form>
        </div>
      </div>
    </div>
