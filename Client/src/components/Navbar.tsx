  ...
  return (
    <nav className=" bg-white sticky top-0 z-50 border-b border-app-border">
      <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4 ">
        ...
        <Link
          to="/"
          className=" flex items-center gap-2 text-5.5 font-medium shrink-0"
        >
        ...
        <div className=" w-full flex items-center justify-end gap-4 lg:gap-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className=" relative">
              {user ? (
                <button
                  onClick={() => setUserMenuOpne(!userMenuOpne)}
                  className=" flex items-center gap-2 p-2"
                >
                  <div className=" size-7 rounded-full bg-green-950 text-white flex-center uppercase">
                    {user.name.charAt(0)}
                  </div>
                ...
                <>
                  ...
                  >
                    <div className=" absolute right-8 top-21 mt-2.5 w-56 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in">
                      ...
                      <div className="" onClick={() => setUserMenuOpne(false)}>
                        {!user && (
